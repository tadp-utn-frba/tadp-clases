...
object test {
  ...
  class C extends T {
    def m(x: Int) = x
    var f = 5
  };import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(149); val res$0 = 

  classOf[Any];System.out.println("""res0: Class[Any](classOf[scala.Any]) = """ + $show(res$0));$skip(26); 
  val classC = classOf[C];System.out.println("""classC  : Class[tadp_reflection_scala.test.C] = """ + $show(classC ));$skip(16); 
  val c = new C;System.out.println("""c  : tadp_reflection_scala.test.C = """ + $show(c ));$skip(42); val res$1 = 
  ...
  val constructorC = classC.getConstructor();System.out.println("""constructorC  : java.lang.reflect.Constructor[tadp_reflection_scala.test.C] = """ + $show(constructorC ));$skip(48); val res$20 = 
  constructorC.newInstance() // returns a new C;System.out.println("""res20: tadp_reflection_scala.test.C = """ + $show(res$20))}
}
