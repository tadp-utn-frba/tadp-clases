require 'rspec'
require_relative '../src/rc/multimethods'
...
describe "Multimethods" do
  ...
  it 'responde multimethods' do
    expect(class_a.multimethods).to eq([:concat])
  end

  # it 'responde a multimethod' do
  #   expect(class_a.multimethod(:concat)).not_to be_nil
  # end
